        ...
        <div class="form-box" style="margin-top: 10px;">
            <form action="" id="phoneLoginForm">
                <div class="form-group input-group">
                    ...
                    <span class="input-group-addon" style="background: none;border: none;padding: 0;"><input class="btn btn-success"  id="verify_refresh" type="button" onclick="regGetMsgNum()" value="免费获取验证码"></span>
                </div>
