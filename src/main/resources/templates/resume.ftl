                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-xs-4 input-group">
                                            ...
                                            <input type="text" required class="form-control"  <#if resume??>value="${resume.jiguan!""}"</#if> name="jiguan">
                                        </div>
                                    <#if userDetail??>
                                        ...
                                        <div class="col-xs-4 input-group">
                                            ...
                                            <input type="text" required class="form-control" <#if resume??>value="${resume.minzu!""}"</#if> name="minzu">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-xs-4 input-group">
                                            ...
                                            <input type="text" class="form-control" name="tall"<#if resume??>value="${resume.tall!""}"</#if>>
                                            <span class="input-group-addon">厘米</span>
                                        </div>
                                        <div class="col-xs-4 input-group">
                                            <span  class="input-group-addon">体重:</span>
                                            <input type="text" maxlength="3" class="form-control"  <#if resume??> value="${resume.weight!""}"</#if> name="weight">
                                ...
                                <div class="panel-body">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xs-4 input-group">
                                            ...
                                            <input type="text" required class="form-control"  <#if resume??>value="${resume.graColl!""}"</#if> name="graColl">
                                        </div>
                                    <#if userDetail??>
                                ...
                                <#if userDetail??>
                                    ...
                                    <div class="form-group row">
                                        <div class="col-xs-4 input-group">
                                            ...
                                            <input type="text"  <#if resume??>value="${resume.stuPro!""}"</#if> class="form-control" name="stuPro">
                                        </div>
                                        <div class="col-xs-4 input-group">
                                            <span  class="input-group-addon">外语水平:</span>
                                            <input type="text"  <#if resume??>value="${resume.english!""}"</#if>  class="form-control" name="english">
                                        </div>
                                        <div class="col-xs-4 input-group">
                                            <span  class="input-group-addon">电脑水平:</span>
                                            <input type="text"  <#if resume??>value="${resume.computer}"</#if>  class="form-control" name="computer">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-xs-10 input-group">
                                            ...
                                            <textarea name="jobDetail" class="form-control" id="" cols="20" rows="3"> <#if resume??>${resume.jobDetail}</#if></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <#if userDetail??>
                                    ...
                                    <#if userDetail??>
                                        ...
                                        <div class="col-xs-4 input-group">
                                            ...
                                            <#if resume??>
                                                <input type="text" class="form-control" value="${resume.workTime}" name="workTime">
                                            <#else>
                                                <input type="text" class="form-control" value="可随时到岗" name="workTime">
                                            </#if>
                                    ...
                                    <div class="form-group row">
                                        <div class="col-xs-6 input-group">
                                            ...
                                            <input type="text" class="form-control"  <#if resume??>value="${resume.jineng!""}"</#if> name="jineng">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-xs-10 input-group">
                                ...
                                <div class="panel-body">
                                    <div class="form-group row">
                                        <div class="col-xs-6 input-group">
                                            ...
                                            <input type="text" class="form-control"  <#if resume??>value="${resume.phone!""}"</#if> name="phone">
                                        </div>
                                        <div class="col-xs-6 input-group">
                                            <span class="input-group-addon">电子邮件</span>
                                            <input type="text" class="form-control"  <#if resume??>value="${resume.email!""}"</#if> name="email">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-xs-6 input-group">
                                            <span class="input-group-addon">腾讯QQ</span>
                                            <input type="text" class="form-control"  <#if resume??>value="${resume.qq!""}"</#if> name="qq">
                                        </div>
                                    </div>
                                </div>
                            </div>
